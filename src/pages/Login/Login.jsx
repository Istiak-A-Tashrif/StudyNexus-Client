...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center mt-4">
      ...
      <form noValidate="" action="" className="space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-1 text-sm">
          <label htmlFor="email" className="block text-gray-700 dark:text-gray-600">Email</label>
          <input
            type="email"
            name="email"
            id="email"
        ...
        <div className="space-y-1 text-sm">
          <label htmlFor="password" className="block text-gray-700 dark:text-gray-600">Password</label>
          <input
            type="password"
            name="password"
            id="password"
          ...
          <div className="flex justify-end text-xs text-gray-600 dark:text-gray-600">
            <a className="hover:text-blue-600 cursor-pointer" rel="noopener noreferrer">Forgot Password?</a>
          </div>
        </div>
        <button className="block w-full p-3 text-center rounded-sm bg-[#7469B6] text-white font-bold hover:bg-blue-200 focus:outline-none focus:bg-[#AD88C6]">Log in</button>
      </form>
      ...
      <div className="flex justify-center space-x-4">
        <button aria-label="Log in with Google" className="btn btn-ghost flex items-center gap-2" onClick={handleGoogleLogin}>
